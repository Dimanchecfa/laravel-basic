        ...
        <div class="card-body">
          <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" cols="4" rows="4" id="inputAddress" placeholder="Description du produit" name="{{ old("description") ?? 'description' }}"></textarea>
              @error('description')
              <p class="text-danger">
                {{ $message }}
              </p>
            ...
            <div class="row">
              <div class="mb-3 col-md-6 col-lg-6">
                ...
                <select id="inputState" class="form-control" name="stock_id">
                  ...
                  <option value="{{ $stock->id }}">{{ $stock->sku }}</option>
                  @endforeach
                </select>
                @error('stock_id')
                <p class="text-danger">
